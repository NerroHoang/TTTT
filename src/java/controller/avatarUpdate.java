...
public class avatarUpdate extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        File currentFolder = new File(realPath);
        File rootFolder = new File(currentFolder.getParentFile().getParentFile() + File.separator + "web" + File.separator + UPLOAD_DIRECTORY);
