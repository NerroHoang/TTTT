...
public class AddQuestionBank extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // Lấy giá trị subjectID từ request (do người dùng chọn trong dropdown)
        int subjectID = Integer.parseInt(request.getParameter("subjectID"));

        // Các thông tin khác từ form
        ...
        for (Part part : request.getParts()) {
            ...
            if (fileName != null && !fileName.isEmpty()) {
                ...
                part.write(filePath);
                if (url1.isBlank()) {
                    url1 = UPLOAD_DIRECTORY + "/" + fileName;
                } else {
                    url2 = UPLOAD_DIRECTORY + "/" + fileName;
                }
            }
        }
        ...
        if (user.getRole() == 1) {
            response.sendRedirect("view-all-question.jsp");
        } else {
