        ...
        <div class="row">
            <div class="col-lg-12">
                <div style="display: flex">
                    <form action="PassDataExamAdd" method="POST" onsubmit="notifyNotApproved(<%= examID %>)">
                        <input type="hidden" name="examID" value="<%= examID %>" />
                        ...
                        <!-- Nếu user.role != 1 -->
                        <button class="btn btn-light">
                            <a href="ViewAllExamTeacher.jsp" style="text-decoration: none; color: Black">Trở về</a>
                        </button>
                        <% } %>
                    ...
                    <button style="margin-left: 5px" class="btn btn-light" data-toggle="modal" data-target="#editPrice">
                        Thay đổi giá tiền
                    </button>
                </div>
                ...
                <div class="modal fade" id="editPrice" tabindex="-1" role="dialog" aria-labelledby="threadModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content" style="width: 500px; margin: auto">
                            <form action="UpdatePriceExam" method="POST">
                                <div class="modal-header d-flex align-items-center bg-primary text-white">
                                    <h6 class="modal-title mb-0" id="threadModalLabel">Đổi giá tiền </h6>
                                </div>
                                <div class="modal-body">
                                    <input type="hidden" name="examID" value="<%=examID%>"/>
                                    <div style="display: flex; align-items: center;">
                                ...
                                <div class="modal-footer">
                                    <input type="button" class="btn btn-light" data-dismiss="modal" value="Huỷ">
                                    <input type="submit" class="btn btn-primary" value="Đổi giá tiền" onsubmit="notifyNotApproved(<%= examID %>)">
                                </div>
                            </form>
                        </div> 
                    </div>                        
