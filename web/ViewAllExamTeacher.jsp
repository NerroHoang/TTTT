...
<%
    if (session.getAttribute("currentUser") != null) {
        ...
        String filter = request.getParameter("filter"); // Lấy giá trị từ form
        List<Exam> exams;

        // Kiểm tra lựa chọn và thay đổi danh sách exams
            ...
            <div class="d-flex align-items-center mb-3">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="filter" id="all" value="all" 
                           <% if(request.getParameter("filter") == null || "all".equals(request.getParameter("filter"))) { %>checked<% } %>>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="filter" id="approved" value="approved" 
                           <% if("approved".equals(request.getParameter("filter"))) { %>checked<% } %>>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="filter" id="notApproved" value="notApproved" 
                           <% if("notApproved".equals(request.getParameter("filter"))) { %>checked<% } %>>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="display: flex; flex-direction: row; text-align: center">
                                        ...
                                        <div class="inner-sidebar-header justify-content-center" style="background-color: green; border-radius: 5px; margin-left: 10px;">
                                            <button
